...
@section('content')
        ...
        <div class="section">
            ...
            <div class="facility-showcase" data-aos="fade-up" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:32px;align-items:center;margin-bottom:44px;">
                <div class="facility-showcase-image" style="position:relative;">
                    <div style="border-radius:18px;overflow:hidden;box-shadow:0 18px 45px rgba(0,0,0,0.18);">
                        <img src="{{ asset('events/event01.jpg') }}" alt="Restaurant &amp; Bar" style="width:100%;height:260px;object-fit:cover;display:block;">
                    </div>
                    <div class="facility-badge" style="position:absolute;top:16px;left:16px;width:40px;height:40px;border-radius:50%;background:#f3b01a;display:flex;align-items:center;justify-content:center;color:#2b0c03;box-shadow:0 10px 26px rgba(0,0,0,0.3);">
                        <i class="fas fa-utensils"></i>
                    </div>
                </div>
                <div class="facility-showcase-content">
                    <h3 class="facility-showcase-title" style="font-family:'Playfair Display',serif;font-size:1.7rem;margin:0 0 8px;color:#3b1a12;">
                        Restaurant &amp; Bar
                    </h3>
                    ...
                    <ul class="facility-features-list" style="list-style:none;padding:0;margin:0 0 12px;display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:6px 18px;font-size:0.9rem;color:#555;">
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Breakfast, Lunch &amp; Dinner Service</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> À la carte and Buffet Options</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Indoor and Outdoor Seating</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Full Bar Service</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Special Dietary Accommodations</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Private Dining Available</li>
                    </ul>
            ...
            <div class="facility-showcase reverse" data-aos="fade-up" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:32px;align-items:center;margin-bottom:44px;">
                <div class="facility-showcase-image" style="position:relative;order:2;">
                    <div style="border-radius:18px;overflow:hidden;box-shadow:0 18px 45px rgba(0,0,0,0.18);">
                        <img src="{{ asset('events/event06.jpg') }}" alt="Conference Rooms" style="width:100%;height:260px;object-fit:cover;display:block;">
                    </div>
                    <div class="facility-badge" style="position:absolute;top:16px;left:16px;width:40px;height:40px;border-radius:50%;background:#f3b01a;display:flex;align-items:center;justify-content:center;color:#2b0c03;box-shadow:0 10px 26px rgba(0,0,0,0.3);">
                ...
                <div class="facility-showcase-content" style="order:1;">
                    ...
                    <ul class="facility-features-list" style="list-style:none;padding:0;margin:0 0 12px;display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:6px 18px;font-size:0.9rem;color:#555;">
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Multiple Room Configurations</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Capacity: 10 - 200 Delegates</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Projectors &amp; Audio Systems</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> High-Speed WiFi</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Whiteboards &amp; Flip Charts</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Professional Event Coordination</li>
                    </ul>
                    <div class="facility-cta" style="margin-top:4px;">
                        <a href="{{ route('functions') }}" class="btn-ghost" style="border-color:#3b1a12;color:#3b1a12;padding:8px 16px;font-size:0.9rem;">
            ...
            <div class="facility-showcase" data-aos="fade-up" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:32px;align-items:center;margin-bottom:44px;">
                <div class="facility-showcase-image" style="position:relative;">
                    <div style="border-radius:18px;overflow:hidden;box-shadow:0 18px 45px rgba(0,0,0,0.18);">
                        <img src="{{ asset('events/event03.jpg') }}" alt="Swimming Pool" style="width:100%;height:260px;object-fit:cover;display:block;">
                    </div>
                    <div class="facility-badge" style="position:absolute;top:16px;left:16px;width:40px;height:40px;border-radius:50%;background:#f3b01a;display:flex;align-items:center;justify-content:center;color:#2b0c03;box-shadow:0 10px 26px rgba(0,0,0,0.3);">
                ...
                <div class="facility-showcase-content">
                    ...
                    <ul class="facility-features-list" style="list-style:none;padding:0;margin:0 0 12px;display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:6px 18px;font-size:0.9rem;color:#555;">
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Heated Outdoor Pool</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Sun Loungers &amp; Umbrellas</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Landscaped Gardens</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Pool Bar Service</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Children&apos;s Pool Area</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Lifeguard on Duty</li>
                    </ul>
                    <div class="facility-hours" style="font-size:0.9rem;color:#444;">
                        <strong>Operating Hours:</strong>
            ...
            <div class="facility-showcase reverse" data-aos="fade-up" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:32px;align-items:center;margin-bottom:44px;">
                <div class="facility-showcase-image" style="position:relative;order:2;">
                    <div style="border-radius:18px;overflow:hidden;box-shadow:0 18px 45px rgba(0,0,0,0.18);">
                        <img src="{{ asset('events/event04.jpg') }}" alt="Banquet Hall" style="width:100%;height:260px;object-fit:cover;display:block;">
                    </div>
                    <div class="facility-badge" style="position:absolute;top:16px;left:16px;width:40px;height:40px;border-radius:50%;background:#f3b01a;display:flex;align-items:center;justify-content:center;color:#2b0c03;box-shadow:0 10px 26px rgba(0,0,0,0.3);">
                ...
                <div class="facility-showcase-content" style="order:1;">
                    ...
                    <ul class="facility-features-list" style="list-style:none;padding:0;margin:0 0 12px;display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:6px 18px;font-size:0.9rem;color:#555;">
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Capacity: Up to 300 Guests</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Customizable Décor</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Professional Sound &amp; Lighting</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Dance Floor</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Stage for Performances</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Full Catering Services</li>
                    </ul>
                    <div class="facility-cta" style="margin-top:4px;">
            ...
            <div class="facility-showcase" data-aos="fade-up" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:32px;align-items:center;">
                <div class="facility-showcase-image" style="position:relative;">
                    <div style="border-radius:18px;overflow:hidden;box-shadow:0 18px 45px rgba(0,0,0,0.18);">
                        <img src="{{ asset('events/event07.jpg') }}" alt="Business Center" style="width:100%;height:260px;object-fit:cover;display:block;">
                    </div>
                    <div class="facility-badge" style="position:absolute;top:16px;left:16px;width:40px;height:40px;border-radius:50%;background:#f3b01a;display:flex;align-items:center;justify-content:center;color:#2b0c03;box-shadow:0 10px 26px rgba(0,0,0,0.3);">
                ...
                <div class="facility-showcase-content">
                    ...
                    <ul class="facility-features-list" style="list-style:none;padding:0;margin:0 0 12px;display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:6px 18px;font-size:0.9rem;color:#555;">
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> High-Speed Internet</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Computers &amp; Printers</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Scanning &amp; Photocopying</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Private Workstations</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Video Conferencing Facilities</li>
                        <li><i class="fas fa-check" style="color:#f3b01a;margin-right:6px;"></i> Secretarial Services Available</li>
                    </ul>
                    <div class="facility-hours" style="font-size:0.9rem;color:#444;">
                        <strong>Operating Hours:</strong>
            ...
            <div class="amenities-grid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;margin-top:24px;">
                ...
                @foreach($amenities as $i => $a)
                    <div class="amenity-card" data-aos="fade-up" data-aos-delay="{{ ($i+1) * 100 }}" style="background:#f7f8f9;border-radius:18px;padding:20px 18px;text-align:left;box-shadow:0 12px 34px rgba(0,0,0,0.05);">
                        <div class="amenity-icon" style="font-size:1.6rem;color:#f3b01a;margin-bottom:8px;">
                            <i class="fas {{ $a['icon'] }}"></i>
                        </div>
                        <h4 class="amenity-title" style="font-family:'Playfair Display',serif;font-size:1.1rem;margin:0 0 4px;color:#3b1a12;">
                            {{ $a['title'] }}
                        </h4>
    ...
    <!-- Facilities CTA -->
    <section class="facilities-cta-section" style="position:relative;padding:70px 0;background:url('{{ asset('events/event04.jpg') }}') center/cover no-repeat;">
        {{-- <div class="facilities-cta-overlay" style="position:absolute;inset:0;background:rgba(15,4,2,0.9);"></div> --}}
